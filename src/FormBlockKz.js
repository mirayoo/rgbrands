...
import cities from './ru-cities-kz.json';
import citiesKz from './kz-cities-kz.json';
      ...
      <div className="wrapper ">
        ...
        <div className="form-hero">
          <div className="form-section-left">
            <picture>
              <source media="(max-width:767px)" srcSet={t('hero.formTitleMob')}/>
