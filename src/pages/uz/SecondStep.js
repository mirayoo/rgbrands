...
import Heading from '../../assets/uz-second-step-heading-ru.png';
...
function SecondStep(props) {
  return (
    <div>
      <SecondBlock headingUrl={Heading} subheadingUrl={SubHeading} heroBg="hero-secondary hero-second-bg"/>
      <div className="list-block" id="content">
        <div className="wrapper list-block-inner">

          <ListItem navLink="/third-step" title={Heading3} titleMob={HeadingMob3} subTitle={Subheading3} subTitleMob={SubheadingMob3} imageUrl={Image3} />

          <ListItem navLink="/third-step" title={Heading4} titleMob={HeadingMob4} subTitle={Subheading4} subTitleMob={SubheadingMob4} imageUrl={Image4} />

          <ListItem navLink="/third-step" title={Heading1} titleMob={HeadingMob1} subTitle={Subheading1} subTitleMob={SubheadingMob1} imageUrl={Image1} />

          <ListItem navLink="/third-step" title={Heading2} titleMob={HeadingMob2} subTitle={Subheading2} subTitleMob={SubheadingMob2} imageUrl={Image2} />

          <ListItem navLink="/third-step" title={Heading5} titleMob={HeadingMob5} subTitle={Subheading5} subTitleMob={SubheadingMob5} imageUrl={Image5} />

          <ListItem navLink="/third-step" title={Heading6} titleMob={HeadingMob6} subTitle={Subheading6} subTitleMob={SubheadingMob6} imageUrl={Image6} />

          <ListItem navLink="/third-step" title={Heading7} titleMob={HeadingMob7} />

          <ListItem navLink="/third-step" title={Heading8} titleMob={HeadingMob8} />
